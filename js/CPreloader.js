function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("200x200_", "./sprites/200x200_.jpg");
    ...
    this.attachSprites = function () {
        ...
        var oBg = new s_oSpriteLibrary.getSprite('200x200');
        _bgIcon = createBitmap(oBg)
        // _oIcon.regX = 100;
        // _oIcon.regY = 100;
        // _oContainer.addChild(oBg);
        _oContainer.addChild(_bgIcon);

        var oSprite = s_oSpriteLibrary.getSprite('200x200_');
        ...
        _oButStart = CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/2, oSprite, TEXT_PRELOADER_CONTINUE, "Arial", "#000", 65, _oContainer);
